...
という意欲的なアイディア。AWS資格を持っているし、この辺りを実際に触ることは意義があると感じました。何よりこの方法なら費用を抑えつつ、GoogleやMicrosoftのアカウントを持っていない人に対しても、アクセスを制限した状態で資料特化型AIチャットを提供することができます。今日はその方法を解説します。
インフラ構成図はこんな感じになります。
